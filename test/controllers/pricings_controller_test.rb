...
class PricingsControllerTest < ActionController::TestCase
  ...
  test "should create pricing" do
    assert_difference('Pricing.count') do
      post :create, pricing: { Item_id: @pricing.Item_id, daily_price: @pricing.daily_price, monthly_price: @pricing.monthly_price, yearly_price: @pricing.yearly_price }
    end
  ...
  test "should update pricing" do
    patch :update, id: @pricing, pricing: { Item_id: @pricing.Item_id, daily_price: @pricing.daily_price, monthly_price: @pricing.monthly_price, yearly_price: @pricing.yearly_price }
    assert_redirected_to pricing_path(assigns(:pricing))
  end
